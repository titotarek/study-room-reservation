...
INSERT INTO `users` (`id`, `name`, `email`, `password_hash`, `role`, `created_at`, `password`) VALUES
(1, 'Test Student', 'student@example.com', 'paswerd123', 'student', '2026-01-12 14:50:22', '$2y$12$eJzesKDaA1vvv9XwbDB/OO4gSpbZbx/DnXIyJfhdHekgCRwAwkfv2'),
(5, 'Project Manager', 'admin@example.com', 'admin123', 'admin', '2026-01-14 20:38:42', '$2a$12$0WsjqG/57r.eUgpf6rfgkueIcJRtcozV4g4P1vEfFbK9ViHfOOa1i');
