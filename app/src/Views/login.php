...
<div class="bg-[#F8FAFC] min-h-screen flex flex-col">
    ...
    <!-- Navigation -->
    <nav class="bg-white/80 backdrop-blur-md sticky top-0 z-50 border-b border-slate-100" aria-label="Guest navigation">
        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.05)] p-8 sm:p-10 border border-slate-100">
                ...
                <?php if (isset($_GET['error'])): ?>
                    <div class="mb-6 p-4 bg-red-50 border border-red-100 text-red-600 rounded-2xl flex items-center gap-3" role="alert" aria-live="assertive">
                ...
                <form id="loginForm" method="POST" action="/login" class="space-y-6">
                    ...
                    <div>
                        <label for="email" class="block text-[11px] font-bold uppercase tracking-[0.2em] text-slate-400 mb-2 ml-1">
                            Email Address
                        </label>
                    ...
                    <div>
                        <label for="password" class="block text-[11px] font-bold uppercase tracking-[0.2em] text-slate-400 mb-2 ml-1">
                            Password
                        </label>
