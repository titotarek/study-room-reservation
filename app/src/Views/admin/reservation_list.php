...
<section class="p-4 md:p-8">
    ...
    <div id="customConfirmModal"
         ...
         role="dialog"
         aria-modal="true"
         aria-labelledby="deleteReservationTitle"
         aria-describedby="deleteReservationDescription"
         aria-hidden="true">
        <div class="bg-white w-full max-w-md rounded-[2.5rem] p-8 shadow-2xl text-center">
            <h3 id="deleteReservationTitle" class="text-2xl font-black text-slate-900 mb-3">Cancel Reservation?</h3>
            <p id="deleteReservationDescription" class="text-slate-500 mb-8">This action cannot be undone.</p>
